            ...
            <form action="<?= base_url('admin/aksi_tambah_pembayaran') ?>" method="post" id="survey-form" class="survey-form w-full">
                <div class="flex flex-wrap">
                    <div class="w-full px-1">
                        ...
                        <select name="nama_siswa" class="w-full min-h-8 p-4 border-b-2 border-gray-300 text-gray-800">
                            ...
                            <?php foreach ($user as $row) : ?>
                                <option value="<?= $row->id ?>"><?= $row->id . ' - ' . $row->nama_siswa ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="w-full px-1">
                    ...
                    <div class="w-full px-1">
                        ...
                        <input type="numer" class="w-full min-h-8 p-4 border-b-2 border-gray-300 text-gray-800" id="total_pembayaran" name="total_pembayaran" value="Rp ">
                    </div>
                    <div class="w-full px-1">
