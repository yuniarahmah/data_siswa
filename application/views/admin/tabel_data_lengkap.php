...
<body>
    ...
    <div class="w-85 mx-full px-10 text-center pt-5">
        <div class="mb-4">
            <label for="search" class="sr-only">Search</label>
            <input type="text" id="search" placeholder="Search..." class="w-full px-4 py-2 border rounded-md">
        </div>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                searchInput.addEventListener("input", function() {
                    ...
                    rows.forEach(function(row) {
                        ...
                        if (searchTerm === "") {
                            // Jika kolom pencarian kosong, tampilkan kembali semua baris
                            row.style.display = "";
                        } else {
