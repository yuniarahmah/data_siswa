...
<body>
    ...
    <div class="md:px-64 py-8 px-5">
        <h1 id="title" class="main-heading text-white dark:bg-gray-800 bg-indigo-600 b-20 rounded-lg mb-5">Tabel data guru</h1>
    </div>
                ...
                <table id="example_pelanggan" class="w-full text-sm text-left text-gray-800 dark:text-gray-700">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        foreach ($guru as $row) : $no++ ?>
                            <tr class="cursor-pointer dark:bg-gray-800 text-gray-700 dark:text-gray-400 ml-2%">
                                <td class="px-3 py-5"><?php echo $no ?></td>
                                <td class="px-3 py-5"><?php echo $row->nama_guru ?></td>
                                <td class="px-3 py-5"><?php echo $row->nik ?></td>
                                <td class="px-3 py-5"><?php echo $row->gender ?></td>
                                <td class="px-3 py-5"><?php echo $row->no_hp ?></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
